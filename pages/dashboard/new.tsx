...
export default function NewProduct() {
    ...
    const [product, setProduct] = useState<Blob | string>('');
            ...
            <div className="flex justify-center">
                <form
                    ...
                    onSubmit={async (e) => {
                        ...
                        body.append('free', free ? 'true' : 'false');
                ...
                >
                    <div className="flex-1 mb-5">
                        ...
                        <div className="relative flex items-start mt-2 mb-3">
                            <div className="flex items-center h-5">
                                <input type="checkbox" checked={free} onChange={(e) => setFree(!free)} />
                            </div>
                        ...
                        {!free && (
                            <>
                                <div className="flex-1 mb-2 text-white">Product price in $ (required)</div>
                                <input
                                    pattern="^\d*(\.\d{0,2})?$"
                    ...
                    <div className="text-sm text-white ">
                        <label className="relative font-medium cursor-pointer  my-3 block">
                            <p className="text-white    ">Product {product && '✅'}</p> (required)
                            <input
                                type="file"
                                className="hidden"
                                onChange={(event) => {
                    ...
                    <button
                        ...
                        className={`border px-8 py-2 mt-10 font-bold  ${title && (free || price) ? '' : 'cursor-not-allowed text-white border-white'
                            }`}
                    >
                        Create product
                    </button>
